...
export function footerToTemplate (data: IFooterWidget): string {
  return `<div id="${data.id} + '_' + ${data.number}" class="ws-footer" style="height: ${data.data.height}px; margin-top: ${data.data.marginTop}px; background: ${data.data.background}">
